...
@Component({
  selector: 'app-teacher-profile-student',
  templateUrl: './teacher-profile-student.component.html',
  styleUrls: ['./teacher-profile-student.component.css']
})
export class TeacherProfileStudentComponent implements OnInit {
