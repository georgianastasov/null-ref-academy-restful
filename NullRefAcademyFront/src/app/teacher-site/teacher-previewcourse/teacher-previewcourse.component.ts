...
@Component({
  selector: 'app-teacher-previewcourse',
  templateUrl: './teacher-previewcourse.component.html',
  styleUrls: ['./teacher-previewcourse.component.css']
})
export class TeacherPreviewcourseComponent implements OnInit {
