...
@Component({
  selector: 'app-teacher-profile-teacher',
  templateUrl: './teacher-profile-teacher.component.html',
  styleUrls: ['./teacher-profile-teacher.component.css']
})
export class TeacherProfileTeacherComponent implements OnInit {
